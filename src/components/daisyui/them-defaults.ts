export const defaultDaisyUiThemes = {
  aqua: {
    "color-scheme": "dark",
    primary: "#09ecf3",
...
interface DefaultThemeStore {
  bears: number
  increase: (by: number) => void
  themes: typeof defaultDaisyUiThemes,
  setTheme: (key: keyof typeof defaultDaisyUiThemes,value:typeof defaultDaisyUiThemes[keyof typeof defaultDaisyUiThemes]) => void
}

export const useDefaultStore = create<DefaultThemeStore>()(
  devtools(
    persist(
      (set) => ({
        bears: 0,
        ...
        setTheme: (key,value) => set((state)=>{
          return {themes: {...state.themes,[key]:value}}
        }),
      }),
      {
        name: 'use-default-theme-storage',
      },
    ),
  ),
)
